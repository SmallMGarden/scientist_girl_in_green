...
class TextTokenizer:
    ...
    def simple_tokenize(self, text):
        ...
        Returns:
            list: Список токенов
        """
        # Реализация простой токенизации, прочитала, что можно установить и вторую границу с помощью \b
    ...
    def nltk_tokenize(self, text):
        ...
        """
        # Реализация NLTK токенизации, true научилась делать еще с работы в классе!
        try:
            import nltk
            ...
            print('Error: can not tokenize (nltk)')
            return None
    ...
    def spacy_tokenize(self, text):
        ...
        try:
            ...
            print('Error: can not tokenize (spacy)')
            return None
    ...
    def tokenize_all(self, text):
        ...
        "nltk": self.nltk_tokenize(text) or [],
        "spacy": self.spacy_tokenize(text) or []
        }
